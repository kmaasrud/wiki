...
Assuming [[0bc45845|full column rank]] for $\mathbf X$, $(\mathbf X^T \mathbf X)$ is thus positive definite (and importantly, invertible). Setting the first derivative to $0$, we get[^elements]:
